...
md_path = "/Users/mayurrathi/.gemini/antigravity-ide/brain/26d18158-f217-4fc0-9cde-11a6f1eab92d/executive_client_guide.md"
pdf_path = "/Users/mayurrathi/.gemini/antigravity-ide/brain/26d18158-f217-4fc0-9cde-11a6f1eab92d/executive_client_guide.pdf"

with open(md_path, "r", encoding="utf-8") as f:
    text = f.read()

# Filter out mermaid diagram blocks for pdf generation
lines = text.split('\n')
clean_lines = []
skip = False
for l in lines:
    if l.strip().startswith('```mermaid'):
        skip = True
        clean_lines.append("[Visual Sitemap Diagram Included in Web Version]")
        continue
...
while i < len(clean_lines):
    ...
    if line.startswith('|'):
        ...
        in_table = False
        if table_data:
            t = Table(table_data, colWidths=[100, 100, 230, 60])
    ...
    if line.startswith('# '):
        ...
        story.append(Paragraph(format_inline(line[5:]), h4_style))
