...
export default function Gallery() {
  ...
  const staticGalleryItems = [
    ...
    { src: '/film/celeb_32.jpg', label: 'Aamir Khan - Dangal Film Campaign' },
    ...
    { src: '/film/celeb_07.jpg', label: 'Kartik Aaryan - Celebrity PR' },
    { src: '/film/celeb_27.jpg', label: 'Ayushmann Khurrana - Press Interaction' },
    { src: '/film/celeb_19.jpg', label: 'Siddharth Malhotra - Artist PR' },
    { src: '/film/celeb_25.jpg', label: 'Saif Ali Khan - Brand Collaboration' },
    { src: '/film/celeb_22.jpg', label: 'Tiger Shroff - Baaghi Movie Campaign' },
    { src: '/film/celeb_23.jpg', label: 'Shraddha Kapoor - Baaghi Promotion' },
    { src: '/film/celeb_09.jpg', label: 'Shraddha & Tiger - Baaghi PR Tour' },
    { src: '/film/celeb_10.jpg', label: 'Sunny Deol - Action Cinema Campaign' },
    { src: '/film/celeb_08.jpg', label: 'Arjun Kapoor - Brand Collaboration' },
    { src: '/film/celeb_29.jpg', label: 'Saif Ali Khan - Celebrity PR Meet' },
    { src: '/film/celeb_30.jpg', label: 'Kartik Aaryan - Film Promotion Tour' },
    ...
    { src: '/film/celeb_02.jpg', label: 'Sonakshi Sinha - Akira Movie Launch' },
    { src: '/film/celeb_16.jpg', label: 'Charlotte Flair (WWE) - Media Activation' },
